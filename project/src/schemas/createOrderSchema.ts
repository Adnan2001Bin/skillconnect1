...
//     revisions: z.number().min(0, "Revisions must be a non-negative number"),
//   }),
//   projectDetails: z.object({
//     title: z.string().min(1, "Project title is required"),
//     description: z.string().min(1, "Project description is required"),
//   }),
//   paymentStatus: z.enum(["pending", "completed", "failed", "cancelled"]).optional().default("pending"), // Added
// });