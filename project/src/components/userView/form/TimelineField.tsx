// components/forms/TimelineField.tsx
import { useFormContext } from "react-hook-form";
import { CalendarDays } from "lucide-react"; // Or the icon you prefer for timeline
import {
  FormControl,
  FormField,
  FormItem,
...
interface TimelineFieldProps {
  ...
  label: string;
  placeholder: string;
  icon?: React.ElementType; // Allow custom icon, defaults to CalendarDays
}
