      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-3 font-sans">
        ...
        >
          {popularServices.map((service) => (
            <Link key={service.id} href={""} className="focus:outline-none">
              <motion.div
                whileHover="hover"
                className="flex flex-col w-[140px] sm:w-[150px] lg:w-[188px] h-[210px] sm:h-[225px] lg:h-[240px] border border-gray-200 rounded-lg hover:border-green-500 hover:shadow-emerald-700 hover:shadow-sm transition-colors duration-300 overflow-hidden bg-[#1A3C34] "
              >
                {/* Header */}
